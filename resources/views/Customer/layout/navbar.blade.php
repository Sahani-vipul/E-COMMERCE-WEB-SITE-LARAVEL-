      ...
      <div class="relative -mx-4 flex items-center justify-center sm:justify-between">
        <div class="w-64 max-w-full px-4 sm:w-60 lg:w-48">
          <a href="index.html" class="block w-full py-5 lg:py-3">
            <img src="{{ asset('/images/logo-sm.png') }}" alt="logo" class="w-6 md:w-8 inline-block">
            <img src="{{ asset('/images/logo-dark.png') }}" alt="logo" class="w-20 md:w-24 inline-block">
          </a>
        </div>
        <div class="w-full items-center justify-end px-4 sm:flex lg:justify-between">
          ...
          <div class="flex w-full items-center justify-end space-x-2 md:space-x-4">
            ...
            <div class="dropdown relative">
             <a href="{{route('add-to-cart')}}"><button
                type="button"
                class="dropdown-toggle flex rounded-full md:me-0 h-10 w-10 items-center justify-center  border-[.5px] dark:border-slate-700/40 bg-[#f4f7ff] text-dark"
                id="Notifications"
                aria-expanded="false"
                 data-fc-autoclose="both" data-fc-type="">
                ...
                {{-- <div class="mb-5 border-b dark:border-slate-700/40 pb-3">
                  <div class="-mx-1 flex items-center justify-between pb-4">
                    <div class="flex items-center px-1">
                      ...
                      <div>
                        <a href="#" class="text-sm font-medium text-black hover:text-brand">
                          Circular Sienna
            ...
            <div class="me-2  dropdown relative">
              <button
                ...
                <img
                  ...
                  src="{{ asset('/images/users/avatar-10.png') }}"
                  alt="user photo"
                  />
                <span class="ltr:ms-2 rtl:ms-0 rtl:me-2 hidden text-left xl:block">
                  <span class="block font-medium text-slate-600 dark:text-gray-300"> @if(auth()->check())
                    {{auth()->user()->name }}  
                    @endif </span>
                </span>
              </button>
          ...
          <div class="w-full">
            ...
            <nav id="mobile-menu-2" class="order-2 hidden w-full items-center justify-between md:order-1 md:ms-5 lg:flex md:w-auto">
              <ul class="blcok items-center lg:flex px-4 md:px-0">
                <li>
                  <a href="{{ route('customer.index') }}" class="flex justify-between py-2 text-base font-medium text-dark hover:text-brand lg:mx-5 lg:inline-flex lg:py-6 2xl:mx-6">
                    Home
                  </a>
                </li>
                <li>
                  <a href="{{ route('customer.product') }}" class="flex justify-between py-2 text-base font-medium text-dark hover:text-brand lg:mx-5 lg:inline-flex lg:py-6 2xl:mx-6">
                    Products
                  </a>
                </li>
                {{-- <li>
                ...
                <li>
                  <a href="{{ route('checkout')}}" class="flex justify-between py-2 text-base font-medium text-dark hover:text-brand lg:mx-5 lg:inline-flex lg:py-6 2xl:mx-6">
                    Checkout
                  </a>
                </li>
                <li>
                    <a href="{{ route('viewOrder')}}" class="flex justify-between py-2 text-base font-medium text-dark hover:text-brand lg:mx-5 lg:inline-flex lg:py-6 2xl:mx-6">
                      Orders
                    </a>
                  </li>
              </ul>
