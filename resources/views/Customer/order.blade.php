                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
                                ...
                                <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                    <a href="{{route('orderDetails',[$item->id] )}}" class="inline-block focus:outline-none text-white hover:bg-brand-500 hover:text-white bg-brand-500 border border-gray-200 text-sm font-medium py-1 px-3 rounded">View</a>
                                </td>
